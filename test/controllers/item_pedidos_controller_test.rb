...
class ItemPedidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create item_pedido" do
    assert_difference('ItemPedido.count') do
      post item_pedidos_url, params: { item_pedido: { pedido_id: @item_pedido.pedido_id, valor: @item_pedido.valor } }
    end
  ...
  test "should update item_pedido" do
    patch item_pedido_url(@item_pedido), params: { item_pedido: { pedido_id: @item_pedido.pedido_id, valor: @item_pedido.valor } }
