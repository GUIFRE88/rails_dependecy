...
class PedidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pedido" do
    assert_difference('Pedido.count') do
      post pedidos_url, params: { pedido: { cliente_id: @pedido.cliente_id, status: @pedido.status, valor_total: @pedido.valor_total } }
    end
  ...
  test "should update pedido" do
    patch pedido_url(@pedido), params: { pedido: { cliente_id: @pedido.cliente_id, status: @pedido.status, valor_total: @pedido.valor_total } }
